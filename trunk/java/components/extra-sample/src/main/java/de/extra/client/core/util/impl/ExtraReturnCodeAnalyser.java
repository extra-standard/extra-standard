...
public class ExtraReturnCodeAnalyser implements IExtraReturnCodeAnalyser {
	...
	@Value(value = "#{'${de.extra.client.core.util.ExtraReturnCodeAnalyser.returncodelist}'.split(',')}")
	 ...
	 */
	@Override
	public boolean isReturnCodeSuccessful(final String extraReturnCode) {
		return positiveReturnCodeList.contains(extraReturnCode);
	}
