...
ALTER TABLE INPUT_DATA 
    ADD CONSTRAINT input_data_requestid UNIQUE ( requestId ) ;
...
CREATE TABLE PROCEDURE_PHASE_CONFIGURATION 
    ( 
     ...
     procedure_type_id NUMBER (10)  NOT NULL , 
     phase_startstatus_id NUMBER (10) 
    ) LOGGING 
;
...
ALTER TABLE PROCEDURE_PHASE_CONFIGURATION 
    ADD CONSTRAINT rel_proc_config_endstatus FOREIGN KEY 
    ( 
     phase_endstatus_id
    ) 
    REFERENCES STATUS 
...
ALTER TABLE PROCEDURE_PHASE_CONFIGURATION 
    ADD CONSTRAINT rel_proc_config_startstatus FOREIGN KEY 
    ( 
     phase_startstatus_id
    ) 
    REFERENCES STATUS 
    ( 
     id
