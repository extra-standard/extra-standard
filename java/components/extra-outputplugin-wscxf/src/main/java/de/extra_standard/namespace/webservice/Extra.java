...
public interface Extra {
	...
	public ResponseTransport execute(
			@WebParam(name = "Transport", targetNamespace = "http://www.extra-standard.de/namespace/request/1", partName = "request") de.drv.dsrv.extrastandard.namespace.request.RequestTransport request)
			throws ExtraFault;
