...
public class FileDataPluginTest {
	...
	public void setUp() throws Exception {
		...
		ReflectionTestUtils.setField(fileDataPlugin, "inputDirectory", inputDirectory);
	}
	...
	public final void testHasMoreData() {
		fileDataPlugin.initInputData();
		Assert.assertTrue("InputData hasMoreData false", fileDataPlugin.hasMoreData());
	}
	...
	public final void testGetData() {
		...
		while (fileDataPlugin.hasMoreData()) {
			...
			Assert.assertTrue(iInputDataContainer.isImplementationOf(FileInputData.class));
