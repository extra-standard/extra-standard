 ...
 * 
 * <p>
 * Die erwartete Abfolge der Ereignisse ist:<code>
 *    requestDataReceived+ requestFilled requestForwarded [responseFilled responseForwarded]
 * </code>
 * </p>
 * 
 * <p>
 * Ob Response Ereignisse auftreten, hängt vom im Request spezifizierten
 * erwarteten Antwortverhalten ab. Die Response-Ereignisse <i>müssen</i>
 * auftreten, wenn der Request eine synchrone Response angefordert hat.
 * </p>
 * 
 * TODO: Acknowledge, Error (extra Kompendium kap. 4.3.2) TODO: Benachrichtigung
 * über extra-LogElement im XMLTransport (Kap. 4.3.4)
 */
public interface ITransportObserver {
	 ...
	 * 
	 * @param unitName
	 *            möglichts eindeutige und menschenlesbare Kurzbezeichnung der
	 ...
	 * 
	 * @param destination
	 *            möglichst eindeutige, menschenlesbare Kurzbezeichnung des
	 *            Ziels (hier zum Beispiel im physikalischen Empfänger); kann
	 *            (zum Beispiel, wenn er ins Dateisystem geschrieben wurde),
	 ...
	 * 
	 * @param status
	 *            status der Requestverarbeitung <i>auf der Transportebene</i>
	 ...
	 * Senders (des Requests).
	 * 
	 * @param destination
	 *            möglichst eindeutige, menschenlesbare Kurzbezeichnung des
	 *            Ziels (hier meist zum logischen Sender) kann (zum Beispiel,
	 *            wenn sie ins Dateisystem geschrieben wurde), muss aber nicht
	 *            spezifisch pro Message sein
	 * @param size
	 *            Größe in Bytes der Transport-Message
	 */
