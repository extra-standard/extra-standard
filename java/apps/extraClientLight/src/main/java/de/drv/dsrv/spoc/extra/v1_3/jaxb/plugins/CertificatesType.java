    ...
    implements Serializable
{
    ...
    @XmlElement(name = "X509EncCertificate")
     ...
     * This is why there is not a <CODE>set</CODE> method for the x509EncCertificate property.
     * 
     * <p>
    ...
    public List<X509CertificateType> getX509EncCertificate() {
        if (x509EncCertificate == null) {
            x509EncCertificate = new ArrayList<X509CertificateType>();
        }
        return this.x509EncCertificate;
    }
